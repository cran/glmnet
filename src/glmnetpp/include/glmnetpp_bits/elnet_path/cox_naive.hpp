...
#include <glmnetpp_bits/elnet_point/cox_naive.hpp>
#include <glmnetpp_bits/elnet_point/internal/cox_naive.hpp>
#include <glmnetpp_bits/util/macros.hpp>

namespace glmnetpp {

/*
 * Cox proportional hazards path solver (naive/dense method).
...
public:
            ...
            const PathConfigPackType&) const
    {
        ...
        return elnet_point_t(
                ...
                sp.x, pack.surv, pack.g, pack.q, sp.vp, sp.cl, sp.ju,
                sp.int_param);
    }
};
