...
compute_cox_quantities_exp <- function(start, stop, status, strata, efron, eta, weights) {
    .Call('_glmnet_compute_cox_quantities_exp', PACKAGE = 'glmnet', start, stop, status, strata, efron, eta, weights)
}

compute_cox_lambda_max_exp <- function(x, start, stop, status, strata, efron, offset, weights, xm, xs, vp, exclude, alpha) {
    .Call('_glmnet_compute_cox_lambda_max_exp', PACKAGE = 'glmnet', x, start, stop, status, strata, efron, offset, weights, xm, xs, vp, exclude, alpha)
}
...
coxnet_exp <- function(parm, x, start, stop, status, strata, efron, g, w, jd, vp, cl, ne, nx, nlam, flmin, ulam, thr, isd, maxit, pb, lmu, a0, ca, ia, nin, nulldev, dev, alm, nlp, jerr) {
    .Call('_glmnet_coxnet_exp', PACKAGE = 'glmnet', parm, x, start, stop, status, strata, efron, g, w, jd, vp, cl, ne, nx, nlam, flmin, ulam, thr, isd, maxit, pb, lmu, a0, ca, ia, nin, nulldev, dev, alm, nlp, jerr)
}
...
spcoxnet_exp <- function(parm, x, start, stop, status, strata, efron, g, w, jd, vp, cl, ne, nx, nlam, flmin, ulam, thr, isd, maxit, pb, lmu, a0, ca, ia, nin, nulldev, dev, alm, nlp, jerr) {
    .Call('_glmnet_spcoxnet_exp', PACKAGE = 'glmnet', parm, x, start, stop, status, strata, efron, g, w, jd, vp, cl, ne, nx, nlam, flmin, ulam, thr, isd, maxit, pb, lmu, a0, ca, ia, nin, nulldev, dev, alm, nlp, jerr)
}

glmnet_control_get <- function() {
    .Call('_glmnet_glmnet_control_get', PACKAGE = 'glmnet')
}

glmnet_control_set <- function(updates) {
    invisible(.Call('_glmnet_glmnet_control_set', PACKAGE = 'glmnet', updates))
}
